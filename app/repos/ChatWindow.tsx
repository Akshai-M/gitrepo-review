...
// export function ChatWindow({ repoId }) {
//   const STORAGE_KEY = `chat_${repoId}`;
...
//   return (
//     <div className="flex flex-col h-screen w-full p-6 bg-white text-black">
//       {/* MESSAGE LIST */}
...
//             key={i}
//             className={`mb-3 ${
//               msg.role === "user" ? "text-blue-700 font-medium" : "text-green-700"
//             }`}
//           >
